...
description = "Create the event in the Google Calendar. Confirm with the user the email, event, start time, and timezone before creating the event. ESPECIALLY THE EMAIL!"
slots = [
    {
        "name": "email",
        "type": "string",
